...
public class AlbumSearchService {
    public static void searchAlbumByArtist(String artistId, String accessToken, Consumer<List<Album>> callback, Consumer<String> onFailure){
        //Api 호출시간 지연 방지하기 위해 new Thread()로 구현
        new Thread(() -> {
            List<Album> result = new ArrayList<>();
            try {
                String urlStr = "https://api.spotify.com/v1/artists/" + artistId + "/albums?market=KR&limit=20";
